...
const faqs = [
  ...
  [
    "Сотрудникам придётся платить за корпоративный челлендж?",
    "Нет. В планируемом B2B-контуре участие будет бесплатным для сотрудников и не будет связано со вступительными взносами, публичными выплатами или другими денежными механиками B2C.",
  ],
  [
    "Как будут соревноваться отделы разного размера?",
    "Через равный зачётный состав. Например, если в одном отделе 10 человек, а в другом 40, обе стороны выставят одинаковое число участников. Победит не самый большой отдел, а самая стабильная команда.",
  ],
  [
    "Увидит ли компания-соперник наших сотрудников и отчёты?",
    "Нет. Внутренние ленты, отчёты и данные сотрудников останутся закрытыми. Сопернику будет доступен только сам матч и его итоговый командный результат.",
  ],
  [
    ...
    <main>
      ...
      <section className="business-stage section-shell" id="business">
        ...
        <div className="business-flow" data-reveal>
          <div className="business-flow-heading">
            <span>КАК ЭТО БУДЕТ РАБОТАТЬ</span>
            <p>От корпоративного пространства до первого командного результата — без смешивания с публичной механикой платформы.</p>
          </div>
          <div className="business-flow-grid">
            <article><b>01</b><h3>СОЗДАЙТЕ КОМПАНИЮ</h3><p>Владелец получит отдельное пространство и будущий B2B-кабинет руководителя.</p></article>
            <article><b>02</b><h3>СОБЕРИТЕ КОМАНДУ</h3><p>Пригласите сотрудников и распределите их по отделам, филиалам или проектным командам.</p></article>
            <article><b>03</b><h3>ЗАПУСТИТЕ ВЫЗОВ</h3><p>Общий челлендж, битва отделов или официальный вызов другой подключённой компании.</p></article>
            <article><b>04</b><h3>СЛЕДИТЕ ЗА РЕЗУЛЬТАТОМ</h3><p>Вовлечённость, подтверждённые дни, прогресс команды, история матчей и B2B-рейтинг.</p></article>
          </div>
        </div>
        ...
        <div className="business-system" data-reveal>
          <article className="fair-match">
            <div className="business-card-label"><span>ПРИМЕР БУДУЩЕЙ ЗАРУБЫ</span><b>14 ДНЕЙ · 10 × 10</b></div>
            <div className="matchup">
              <div><small>ПРОДАЖИ</small><strong>86%</strong><span>10 участников</span></div>
              <b><i>VS</i><strong>10 × 10</strong><small>ЗАЧЁТНЫЙ СОСТАВ</small></b>
              <div><small>РАЗРАБОТКА</small><strong>81%</strong><span>10 участников</span></div>
            </div>
            <p>Победит команда, которая стабильнее выполняет условия всем зачётным составом. Пропущенные дни не исчезают из статистики, а размер отдела или компании не даёт преимущества.</p>
          </article>
